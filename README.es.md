...
Proyecto backend desarrollado como práctica profesional de Node.js, MongoDB y APIs REST, enfocado en arquitectura limpia, seguridad y reglas de negocio reales.